...
void choice_shed(){
  ...
  if (choice == "1") {
    ...
    cout << "A cat darts out of it." << endl;
    choice_shed_hole();
  }
  else if (choice == "2") {
  ...
  void choice_shed_hole(){
    cout << "Do you: " << endl;
    cout << "1. Sneak into the hole" << endl;
    cout << "2. Follow the cat" << endl;
    cout << "3. Give up and go home" << endl;
    string choice;
    cout << "Choose: ";
    cin >> choice;
    if (choice == "1"){
      ...
      cout << "The cat leads you under a bush." << endl;
      cout << "There are kittens under the bush!" << endl;
      choice_cat();
    }
    else if (choice == "3") {
      cout << "You decide to go back home." << endl;
 ...
 void choice_cat(){
   cout << "Do you: " << endl;
   cout << "1. Feed the cat family" << endl;
   cout << "2. Go back to the hole" << endl;
   string choice;
   cout << "Choose: ";
   cin >> choice;
   if (choice == "1"){
     cout << "You pull out a bag of beef jerky and feed it to the cat (who knows if that's good for it)." << endl;
     cout << "The cat is pleased! It leads you to a small clearing and digs a hole." << endl;
     cout << "In the hole there's a glass orb! Maybe it's valuable?" << endl;
     cout << "You return home." << endl;
     cout << "THE END" << endl;
   }
   else if (choice == "2"){
     cout << "You return to the hole." << endl;
     cout << "You sneak in and steal a walking cane. Is it cursed? Who knows!" << endl;
     cout << "You go home." << endl;
     cout << "THE END" << endl;
   }
